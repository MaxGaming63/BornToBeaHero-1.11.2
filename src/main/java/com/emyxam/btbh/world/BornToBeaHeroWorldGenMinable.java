...
public class BornToBeaHeroWorldGenMinable extends WorldGenerator {
    ...
    public BornToBeaHeroWorldGenMinable(IBlockState state, int blockCount, int dimension)
    {
    ...
    public BornToBeaHeroWorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> predicate)
    {
        this.oreBlock = state;
    ...
    // Just taken from WorldGenMineable source.
