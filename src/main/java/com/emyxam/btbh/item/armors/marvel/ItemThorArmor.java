...
public class ItemThorArmor extends net.minecraft.item.ItemArmor implements ItemModelProvider {

    private String name;

    public ItemThorArmor(ArmorMaterial material, EntityEquipmentSlot slot, String name) {
    ...
    public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack) {
        ...
        if (head != null && head.getItem() instanceof ItemThorArmor && chest != null && chest.getItem() instanceof ItemThorArmor && legs != null && legs.getItem() instanceof ItemThorArmor && feet != null && feet.getItem() instanceof ItemThorArmor || entity.capabilities.isCreativeMode || entity.isSpectator()) {
    ...
    public static class AbilityHandler {
        ...
        public static boolean playerHasSet(EntityPlayer entity) {
            ...
            return head != null && head.getItem() instanceof ItemThorArmor && chest != null && chest.getItem() instanceof ItemThorArmor && legs != null && legs.getItem() instanceof ItemThorArmor && feet != null && feet.getItem() instanceof ItemThorArmor;
        }
