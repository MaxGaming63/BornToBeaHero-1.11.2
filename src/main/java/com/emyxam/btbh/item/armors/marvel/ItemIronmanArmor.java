...
public class ItemIronmanArmor extends net.minecraft.item.ItemArmor implements ItemModelProvider {

    private String name;

    public ItemIronmanArmor(ArmorMaterial material, EntityEquipmentSlot slot, String name) {
    ...
    public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack) {
        ...
        if (head != null && head.getItem() instanceof ItemIronmanArmor && chest != null && chest.getItem() instanceof ItemIronmanArmor && legs != null && legs.getItem() instanceof ItemIronmanArmor && feet != null && feet.getItem() instanceof ItemIronmanArmor || entity.capabilities.isCreativeMode || entity.isSpectator()) {
    ...
    public static class abilityHandler {
        ...
        public static boolean playerHasSet(EntityPlayer entity) {
            ...
            return head != null && head.getItem() instanceof ItemIronmanArmor && chest != null && chest.getItem() instanceof ItemIronmanArmor && legs != null && legs.getItem() instanceof ItemIronmanArmor && feet != null && feet.getItem() instanceof ItemIronmanArmor;
        }
