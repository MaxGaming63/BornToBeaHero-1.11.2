...
public class ModRecipes {
    ...
    public static void init() {
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.captain_leggins),"WAW","W W","W W", 'W', Blocks.WOOL, 'A', ModItems.ingotAmantium);
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.eye_leggins),"LAL","L L","L B", 'L', Items.LEATHER, 'A', ModItems.ingotAmantium, 'B', Items.DYE);
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.man_leggins),"IAI","I I","I I", 'I', Items.IRON_INGOT, 'A', ModItems.ingotAmantium);
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.hulk_leggins),"EAE","E E","E E", 'E', Blocks.EMERALD_BLOCK, 'A', ModItems.ingotAmantium);
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.black_leggins),"LAL","L L","B L", 'L', Items.LEATHER, 'A', ModItems.ingotAmantium, 'B', Items.DYE);
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModItems.thor_leggins),"IIA","I I","I I", 'I', Items.IRON_INGOT, 'A', ModItems.ingotAmantium);
